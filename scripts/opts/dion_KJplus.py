...
class DionKJPlus(Optimizer):
    def __init__(
        ...
        total_steps: int=3000, # Total training steps    
        qr_warmup: float = 0.1,  # Warm-up factor for QR
    ):
        if lr < 0.0:
            ...
            if algo == "dion":
                ...
                for i, param in enumerate(group["params"]):
                    ...
                    if i % world_size == rank:
                        ...
                        if step >= int(self.qr_warmup * self.total_steps):
                            approx_method = "cqr"
