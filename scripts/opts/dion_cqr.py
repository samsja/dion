...
class DionCQR(Optimizer):
    def __init__(
        ...
        qr_warmup: int = 200,  # Percentage of total steps to use QR method
    ):
        if lr < 0.0:
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            #if step >= int(self.qr_warmup * self.total_steps) and algo == "dion":
            #    print("Entering Cholesky QR mode for Dion optimizer.")
            ...
            if algo == "dion":
                ...
                for i, param in enumerate(group["params"]):
                    ...
                    if i % world_size == rank:
                        ...
                        if step >= self.qr_warmup:
                            approx_method = "cqr" # Use Cholesky after getting to good region
